...
from lh import Engine_2ban, Engine_2ban_dixi, Engine_1ban_dixi, SingleStock_daily, AllStock_daily
...
def huice_1ban_dixi_working():
    ...
    chg_pct=(change/e_1d.dayStamps[e_1d.trade_date].start_total-1)*100
    end_tags = dict()
...
@huice_bp.route('/tongshougong')
def huice_tongshougong():
    # return '666'
    return flask.render_template('huice/tongshougong.html', engine=e)
@huice_bp.route('/tongshougong/set_time_span', methods=['POST'])
def huice_tongshougong_set_time_span():
    print('in set_time_span')
    trade_time_beg = flask.request.form.get('trade_time_beg')
    trade_time_end = flask.request.form.get('trade_time_end')
    if e.set_date_span(beg_date=trade_time_beg, end_date=trade_time_end):
        return flask.redirect('/huice/tongshougong/show')
    else:
        return flask.redirect('/huice/tongshougong')
@huice_bp.route('/tongshougong/show')
def huice_tongshougong_show():
